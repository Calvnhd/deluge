...
_CLOUD_LOG_PATH = Path(__file__).resolve().parent / "data" / "cloud_sync.log"
...
def main(argv: list[str] | None = None) -> None:
    ...
    append_sync_log(result, elapsed_seconds=elapsed, log_path=_CLOUD_LOG_PATH)
